...
{
    public partial class finish_table_relations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favorite", x => new { x.EntryId, x.UserId });
                    table.ForeignKey(
                        name: "FK_Favorite_Entries_EntryId",
                        column: x => x.EntryId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vote", x => new { x.EntryId, x.UserId });
                    table.ForeignKey(
